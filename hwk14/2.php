...
<head>
    ...
    <title>Overwatch: Baptiste is Now Live</title>
</head>
<body>
<p class = "sub">Overwatch</p>
<p>
Baptiste is now available to play with the most recent Overwatch update.
<br>Baptiste is a support hero that has the ability to heal allies.
</p></body>
</html>
